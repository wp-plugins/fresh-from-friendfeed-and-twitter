...
* A magic formulae is used to determine the best posts to import. If you don't want to keep an imported post, simply delete it and Fresh From will automatically find some other content.
